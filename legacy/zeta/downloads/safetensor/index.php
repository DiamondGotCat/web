...
<html lang="en-US">
  <head>
    <title>Safetensor Downloads - Zeta LLM</title>
    <meta name="description" content="Safetensor Downloads - Zeta LLM Website">
    ...
    <main>
      <div class="flex">
            ...
            <ul class="mt-6 space-y-1">
              ...
              <li>
                  ...
                  <ul class="mt-2 space-y-1 px-4">
                    <li>
                      <a href="../safetensor" class="block rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700" >Safetensor </a>
                    </li>
                    <li>
        ...
        <div class="flex-1 p-8">
          ...
          <h1 class="text-3xl font-bold">Safetensor</h1>

          <div class="py-4"></div>

          <h2 class="text-xl pb-4">Normal</h2>
          <section id="downloads1" class="flex flex-row">
            <article class="flex-1 rounded-xl border-2 border-gray-100 bg-white">
              <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
                ...
                <div>
                  ...
                  <p class="line-clamp-2 text-sm text-gray-700">Zeta-LLM</p>
                </div>
              </div>
              <div class="flex justify-end">
                <a href="https://huggingface.co/Zeta-LLM/Zeta-4/">
            ...
            <article class="flex-1 rounded-xl border-2 border-gray-100 bg-white">
              ...
              <div class="flex justify-end">
                <a href="https://huggingface.co/Zeta-LLM/Zeta-3/">
                    <strong class="-me-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-ss-xl rounded-ee-xl bg-blue-600 px-3 py-1.5 text-white" >
                        <span class="text-[10px] font-medium sm:text-xs">></span>
                    </strong>
                </a>
          ...
          <section id="downloads2" class="flex flex-row">
            <article class="flex-1 rounded-xl border-2 border-gray-100 bg-white">
              ...
              <div class="flex justify-end">
                <a href="https://huggingface.co/Zeta-LLM/Zeta-2/">
                    <strong class="-me-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-ss-xl rounded-ee-xl bg-blue-600 px-3 py-1.5 text-white" >
                        <span class="text-[10px] font-medium sm:text-xs">></span>
                    </strong>
                </a>
            ...
            <article class="flex-1 rounded-xl border-2 border-gray-100 bg-white">
              ...
              <div class="flex justify-end">
                <a href="https://huggingface.co/Zeta-LLM/Zeta-1/">
                    <strong class="-me-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-ss-xl rounded-ee-xl bg-blue-600 px-3 py-1.5 text-white" >
                        <span class="text-[10px] font-medium sm:text-xs">></span>
                    </strong>
                </a>
